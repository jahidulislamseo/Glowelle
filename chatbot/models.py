...
class ChatbotSettings(models.Model):
    welcome_message = models.TextField(
        default="👋 Hi! Welcome to Nyveralife! How can I help you today?",
        help_text="First message shown when the chat opens"
    )
    system_prompt = models.TextField(
        default="You are 'Nyveralife Assistant'. Be helpful, confident, and professional. Use product data provided. Guarantee 100% freshness.",
