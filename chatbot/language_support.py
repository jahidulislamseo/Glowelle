"""
Multi-Language Support for Nyveralife Chatbot
...
def get_system_prompt_by_language(language):
    ...
    """
    prompts = {
        'bengali': """তুমি 'Nyveralife' এর একজন সহায়ক সহকারী। তুমি গ্রাহকদের পণ্য খুঁজে পেতে, অর্ডার করতে এবং প্রশ্নের উত্তর দিতে সাহায্য কর।
...
""",
        ...
        'english': """You are a helpful assistant for 'Nyveralife'. You help customers find products, place orders, and answer questions.
...
""",
        ...
        'banglish': """Tumi 'Nyveralife' er ekjon helpful assistant. Tumi customers ke product khuje pete, order korte ebong questions er answer dite help koro.
